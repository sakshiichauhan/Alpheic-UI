          ...
          <div className="relative z-10 flex flex-col md:gap-[32px] gap-4">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-[40px]">
              ...
              <div className="flex gap-2 text-left w-full">
                <div>
                  <h3 className="2xl:text-[40px] lg:text-[32px] md:text-[28px] sm:text-[24px] text-[20px] font-bold flex items-center gap-2">
                    <Phone className="w-auto 2xl:h-8 h-4 text-white shrink-0" strokeWidth={1.5} />
                    {advertises}
                  </h3>
                  {subAdvertises ? (
                    <div className="mt-1 2xl:text-[20px] lg:text-[18px] md:text-[16px] text-[15px] text-white flex items-center gap-2">
                      <span aria-hidden="true" className="bg-white w-6 h-[2px] block"></span>
                      <ParsedHtml htmlContent={subAdvertises} as="span" className="font-semibold" />
                    </div>
                  ) : (
                    <p className="mt-1 2xl:text-[20px] lg:text-[18px] md:text-[16px] text-[15px] text-white flex items-center gap-2">
                      <span aria-hidden="true" className="bg-white w-6 h-[2px] block"></span>
                      <span className="font-semibold">15 minutes </span> to see if we're a fit.
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="flex justify-end sm:justify-start">
                <button 
                  className="bg-white text-[#000000] md:px-[34px] px-[8px] md:py-3 py-[6px] 2xl:w-[174px] h-fit 2xl:text-[24px] text-[14px] font-urbanist inline-flex items-center justify-center whitespace-nowrap leading-none"
