          ...
          {filteredPrograms.map((program) => (
            <div key={program.id} className="border border-[#E8E9E9] p-4 bg-white">
              ...
              <div className="flex gap-2 mt-3">
                <button className="flex-1 px-3 py-1 border border-black text-[12px]">View</button>
                <button className="flex-1 px-3 py-1 bg-black text-white text-[12px] hover:bg-gray-800">Start</button>
              </div>
            </div>
          ))}
        </div>
