...
const TechnologyBuild: React.FC<Props> = ({
  title = "Technology",
  kicker = "Building Intelligent, Secure, and Scalable Futures.",
  description = `Amid waves of digital disruption, Alpheric helps technology companies design strategies, products, and platforms that sustain growth and stay ahead of change.`,
  className = "",
}) => {
  return (
