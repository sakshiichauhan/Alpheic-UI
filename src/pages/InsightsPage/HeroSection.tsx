...
const InsightsHeroSection: React.FC<Props> = ({
  title = "Insights",
  kicker = "Insights identify and recommend policy changes to improve performance on your selected metrics.",
  description = `Insights identify and recommend policy changes to improve performance on your selected metrics.`,
}) => {
  return (
    <section
    ...
    >
      <div className="px-4 sm:px-6 md:px-12 lg:px-[80px] xl:px-[120px] 2xl:px-[200px] 2xl:pt-[190px] xl:pt-[160px] lg:pt-[140px] md:pt-[120px] pt-[110px] lg:pb-[64px] pb-[40px]">
