...
const AccordionItem: React.FC<AccordionItemProps> = ({ q, a, isOpen, onToggle }) => {
  ...
  return (
    <div className={`transition-all duration-300 ease-in-out border ${isOpen ? "border-[#E5E7EA]/50 p-[12px] sm:p-[16px] md:p-[20px] lg:p-[24px]" : "border-transparent px-[12px] py-[8px] sm:px-[16px] sm:py-[10px] md:px-[20px] md:py-[12px] lg:px-[24px] lg:py-[16px]"}`}>
      <button
        id={`faq-btn-${uid}`}
