...
import imageSrc from "@/assets/ContractUS/subhero.png";

type ContractusSubheroProps = {
  imageAlt?: string;
};

const ContractusSubhero: React.FC<ContractusSubheroProps> = ({
  imageAlt = "Team collaborating in an office",
}) => {
  return (
    <section className="w-full bg-zinc-50" aria-label="Company sub-hero">
          ...
          <div className="w-full items-right">
            <div className="relative bg-white ">
              <img
                src={imageSrc}
                alt={imageAlt}
                className="h-full max-h-[572px] lg:w-[960px] w-full object-cover object-center lg:ml-auto"
              />
            </div>
          </div>
        </div>
...
export default ContractusSubhero;
