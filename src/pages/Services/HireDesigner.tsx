            ...
            <div className="flex flex-col justify-center order-2 xl:order-1 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 2xl:p-14">
              {title ? (
                <ParsedHtml
                  htmlContent={title}
                  as="h1"
                  className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-[60px] 2xl:text-7xl font-semibold text-black mb-4 font-instrument-sans leading-tight"
                />
              ) : (
                <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-[60px] 2xl:text-7xl font-semibold text-black mb-4 font-instrument-sans leading-tight">
                  Hire a Designer
                </h1>
              )}
              ...
              {heading ? (
                <ParsedHtml
                  htmlContent={heading}
                  as="p"
                  className="text-base sm:text-lg md:text-2xl xl:text-[24px] text-[#3E3E3E] mb-3 2xl:mb-6 font-semibold font-urbanist leading-snug"
                />
              ) : (
              ...
              {description ? (
                <ParsedHtml
                  ...
                  as="p"
                  className="text-sm sm:text-base md:text-lg xl:text-xl 2xl:text-2xl font-light font-urbanist text-[#3E3E3E] mb-6 2xl:mb-8 leading-relaxed"
                />
              ) : (
